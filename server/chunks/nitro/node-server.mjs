...
const _inlineRuntimeConfig = {
  ...
  "public": {},
  "accessSecret": "\"RoCoX BBS AccessToken Secret\";",
  "refreshSecret": "RoCoX BBS RefreshToken Secret"
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\Code\\Repo\\RoCoX-BBS\\.data\\kv"}));
...
const assets = {
  ...
  "/_nuxt/entry.301ef1a8.js": {
    "type": "application/javascript",
    "etag": "\"2034c-q+BRyFAXGs6mErpEre+t+pd90XU\"",
    "mtime": "2023-09-03T11:52:51.230Z",
    "size": 131916,
    "path": "../public/_nuxt/entry.301ef1a8.js"
  },
  "/_nuxt/entry.38fc3c85.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"3e7f-o4/27TDWKXgSH5dri+op0bOyVmQ\"",
    "mtime": "2023-09-03T11:52:51.232Z",
    "size": 15999,
    "path": "../public/_nuxt/entry.38fc3c85.css"
  },
  "/_nuxt/error-404.36bc4e75.js": {
    "type": "application/javascript",
    "etag": "\"1983-NFB/FV9PqquxlIv9CmkjUhXnBeo\"",
    "mtime": "2023-09-03T11:52:51.232Z",
    "size": 6531,
    "path": "../public/_nuxt/error-404.36bc4e75.js"
  },
  ...
  "/_nuxt/error-500.50984b25.js": {
    "type": "application/javascript",
    "etag": "\"756-pqQHUJ/wCtfPItl995wvT3H/8q0\"",
    "mtime": "2023-09-03T11:52:51.231Z",
    "size": 1878,
    "path": "../public/_nuxt/error-500.50984b25.js"
  },
...
const _iBUL0P = defineEventHandler(async (event) => {
  var _a;
  ...
  if (!isHandledByThisMiddleware)
    return;
  const token = (_a = event.node.req.headers["authorization"]) == null ? void 0 : _a.split(" ")[1];
...
const _lazy_31bPa6 = () => import('../login.post.mjs');
const _lazy_Uu9kSH = () => import('../logout.post.mjs');
const _lazy_hq2eWX = () => import('../refresh.get.mjs');
const _lazy_uuUSFg = () => import('../register.post.mjs');
const _lazy_1uXbjB = () => import('../user.get.mjs');
const _lazy_yDC5uu = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _iBUL0P, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/login', handler: _lazy_31bPa6, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_Uu9kSH, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/refresh', handler: _lazy_hq2eWX, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/register', handler: _lazy_uuUSFg, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/user', handler: _lazy_1uXbjB, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_yDC5uu, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_yDC5uu, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, withQuery as A, hasProtocol as B, parseURL as C, isScriptProtocol as D, sanitizeStatusCode as E, createHooks as F, isEqual as G, stringifyParsedURL as H, stringifyQuery as I, parseQuery as J, withTrailingSlash as K, withoutTrailingSlash as L, nodeServer as M, defineEventHandler as a, generateTokens as b, createError$1 as c, dr as d, sendRefreshToken as e, getCookie as f, getUserByUsername as g, decodeRefreshToken as h, getUserById as i, createUser as j, eventHandler as k, setResponseHeader as l, send as m, getResponseStatus as n, setResponseStatus as o, prisma as p, setResponseHeaders as q, readBody as r, sendError as s, joinURL as t, useNitroApp as u, useRuntimeConfig as v, wn as w, getQuery as x, getRouteRules as y, getResponseStatusText as z };
